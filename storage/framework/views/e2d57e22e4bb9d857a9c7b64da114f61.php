...
<div class="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-indigo-900 relative">
    ...
    <div class="relative z-10 container mx-auto px-4 py-8">
        ...
        <?php if($workoutPlans->count() > 0): ?>
            ...
            <?php $__currentLoopData = $groupedPlans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trainorId => $plans): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <div class="mb-8">
                    <div class="flex items-center mb-4 border-b border-white/20 pb-2">
                        <?php if($memberTrainor && $trainorId == $memberTrainor->id): ?>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div class="glass-effect rounded-xl p-6 hover:shadow-xl hover:shadow-purple-500/20 hover:scale-105 transition-all duration-500 stagger-animation" style="animation-delay: <?php echo e($index * 0.1); ?>s;">
                            <div class="flex justify-between items-start mb-4">
                                <div class="flex-1">
                                    <div class="flex items-center mb-3">
                                        <div class="w-12 h-12 rounded-lg flex items-center justify-center mr-4 <?php if($plan->category_goal == 'Beginner'): ?> bg-green-500/20 <?php elseif($plan->category_goal == 'Intermediate'): ?> bg-yellow-500/20 <?php else: ?> bg-red-500/20 <?php endif; ?>">
                                            <?php if($plan->category_goal == 'Beginner'): ?>
                                                <svg class="w-6 h-6 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"></path>
                                                </svg>
                                            <?php elseif($plan->category_goal == 'Intermediate'): ?>
                                        ...
                                        <div>
                                            <h3 class="text-lg md:text-xl font-semibold text-white mb-1"><?php echo e($plan->title); ?></h3>
                                            <span class="bg-<?php echo e($plan->category_goal == 'Beginner' ? 'green' : ($plan->category_goal == 'Intermediate' ? 'yellow' : 'red')); ?>-500/20 text-<?php echo e($plan->category_goal == 'Beginner' ? 'green' : ($plan->category_goal == 'Intermediate' ? 'yellow' : 'red')); ?>-400 px-3 py-1 rounded-full text-xs md:text-sm font-medium">
                                                <?php echo e($plan->category_goal); ?>

                                            </span>
                                        </div>
                                    </div>
                                    <p class="text-gray-300 mb-4 text-sm md:text-base leading-relaxed"><?php echo e($plan->description); ?></p>
                                </div>
                            </div>

                            <!-- View Button -->
                            <div class="mt-6">
                                <a href="<?php echo e(route('member.workout_plans.show', $plan->id)); ?>" class="btn-ripple inline-flex items-center px-6 py-3 text-sm md:text-base bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white font-medium rounded-xl transition-all duration-300 shadow-lg hover:shadow-blue-500/25 transform hover:scale-105">
...
<?php endif; ?>
<?php /**PATH D:\Downloads\fitnessgains.site (2)\fitnessgains.site (1)\willie\resources\views/member/workout_plans/index.blade.php ENDPATH**/ ?>