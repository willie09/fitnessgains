            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                    ...
                    <div class="group glass-effect border border-white/20 rounded-2xl p-4 sm:p-6 shadow-xl hover:border-emerald-400/50 transition-all duration-300 hover:transform hover:scale-105">
                        <div class="flex items-center space-x-3 sm:space-x-4">
                            ...
                            <div>
                                    <h4 class="text-xl sm:text-2xl font-bold text-white mb-1"><?php if($isActive): ?> Active <?php else: ?> Expired <?php endif; ?></h4>
                                    ...
                                    <div class="w-full bg-white/10 rounded-full h-1 mt-2">
                                        <div class="bg-gradient-to-r from-emerald-500 to-cyan-500 h-1 rounded-full <?php if($isActive): ?> w-full <?php else: ?> w-0 <?php endif; ?>"></div>
                                    </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="group glass-effect border border-white/20 rounded-2xl p-4 sm:p-6 shadow-xl hover:border-blue-400/50 transition-all duration-300 hover:transform hover:scale-105">
                        <div class="flex items-center space-x-3 sm:space-x-4">
                            ...
                            <div>
                                <h4 class="text-xl sm:text-2xl font-bold text-white mb-1"><?php echo e($daysRemaining); ?></h4>
                                <p class="text-white/70 text-xs sm:text-sm font-medium">Days Remaining</p>
                                <div class="w-full bg-white/10 rounded-full h-1 mt-2">
                                    <div class="bg-gradient-to-r from-blue-500 to-cyan-500 h-1 rounded-full <?php if($daysRemaining > 0): ?> w-3/4 <?php else: ?> w-0 <?php endif; ?>"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center space-x-3 sm:space-x-4">
                            ...
                            <div>
                                <h4 class="text-lg sm:text-xl font-bold text-white mb-1">
                                    <?php if($member->trainor): ?>
                                        <?php echo e($member->trainor->name); ?>
                                ...
                                <div class="w-full bg-white/10 rounded-full h-1 mt-2">
                                    <div class="bg-gradient-to-r from-purple-500 to-pink-500 h-1 rounded-full <?php if($member->trainor): ?> w-full <?php else: ?> w-0 <?php endif; ?>"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                    ...
                    <div class="glass-effect border border-white/20 rounded-2xl p-8 shadow-xl">
                        ...
                        <div class="space-y-4">
                            <?php $__currentLoopData = $workoutPlans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-white/10">
                                <div>
                                    <h4 class="text-white font-semibold"><?php echo e($plan->title); ?></h4>
                                    <p class="text-gray-400 text-sm"><?php echo e($plan->description); ?></p>
                                </div>
                                <a href="<?php echo e(route('member.workout_plans.show', $plan->id)); ?>" class="px-4 py-2 bg-gradient-to-r from-emerald-500 to-cyan-500 text-white rounded-lg hover:from-emerald-600 hover:to-cyan-600 transition-all duration-300 inline-block">
                                    View Plan
                                </a>
                            </div>
                    ...
                    <div class="glass-effect border border-white/20 rounded-2xl p-8 shadow-xl">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-white/10">
                                <div>
                                    <h4 class="text-white font-semibold"><?php echo e($order->product->product_name); ?></h4>
                                    <p class="text-gray-400 text-sm">Qty: <?php echo e($order->quantity); ?> | P<?php echo e(number_format($order->total_amount, 2)); ?></p>
                                </div>
                                <div class="text-right">
                                    <span class="px-2 py-1 bg-blue-500/20 text-blue-400 rounded-full text-xs"><?php echo e(ucfirst($order->status)); ?></span>
                                    <p class="text-gray-400 text-xs mt-1"><?php echo e($order->order_date->format('M j')); ?></p>
                                </div>
                            </div>
...
<?php endif; ?>
<?php /**PATH D:\Downloads\fitnessgains.site (2)\fitnessgains.site (1)\willie\resources\views/member-portal.blade.php ENDPATH**/ ?>