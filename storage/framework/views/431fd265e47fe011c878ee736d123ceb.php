...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo e(config('app.name', 'Member Portal')); ?></title>
    ...
    <body class="font-sans antialiased bg-gradient-to-br from-slate-900 via-purple-900 to-indigo-900 min-h-screen">
        <div class="min-h-screen relative">
            ...
            <div class="relative z-10">
                <?php echo $__env->make('layouts.navs', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                ...
                <footer class="bg-white/5 backdrop-blur-sm border-t border-white/10 mt-12">
                    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                        <div class="text-center text-white/70 text-sm">
                            © <?php echo e(date('Y')); ?> Member Portal. All rights reserved.
                        </div>
                    </div>
                </footer>
            </div>
...
<?php /**PATH D:\Downloads\fitnessgains.site (2)\fitnessgains.site (1)\willie\resources\views/layouts/mapp.blade.php ENDPATH**/ ?>