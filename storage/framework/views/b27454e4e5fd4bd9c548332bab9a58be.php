                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                <?php $__empty_1 = true; $__currentLoopData = $workoutPlans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $workoutPlan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="workout-plan-row">
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-100"><?php echo e($workoutPlan->title); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400"><?php echo e($workoutPlan->trainor->name ?? 'N/A'); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400"><?php echo e($workoutPlan->category_goal); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400"><?php echo e($workoutPlan->exercises->count()); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="<?php echo e(route('admin.workout_plans.show', $workoutPlan->id)); ?>" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300 mr-2">View</a>
                                            <button onclick="openEditWorkoutPlanModal(<?php echo e($workoutPlan->id); ?>, '<?php echo e($workoutPlan->trainor_id); ?>', '<?php echo e(addslashes($workoutPlan->title)); ?>', '<?php echo e(addslashes($workoutPlan->description)); ?>', '<?php echo e(addslashes($workoutPlan->category_goal)); ?>')" class="text-green-600 hover:text-green-900 dark:text-green-400 dark:hover:text-green-300 mr-2">Edit</button>
                                            <form action="<?php echo e(route('admin.workout_plans.destroy', $workoutPlan->id)); ?>" method="POST" class="inline">
                                                <?php echo csrf_field(); ?>
    ...
    <div id="addWorkoutPlanModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
        <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-1/2 shadow-lg rounded-md bg-white dark:bg-gray-800">
            <div class="mt-3">
                ...
                <form id="addWorkoutPlanForm" method="POST" action="<?php echo e(route('admin.workout_plans.store')); ?>" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    <div>
                        ...
                        <select name="trainor_id" id="trainor_id" required class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            ...
                            <?php $__currentLoopData = $trainors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trainor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($trainor->id); ?>"><?php echo e($trainor->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <?php $__errorArgs = ['trainor_id'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="title" id="title" value="<?php echo e(old('title')); ?>" required class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="category_goal" id="category_goal" value="<?php echo e(old('category_goal')); ?>" required class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        <?php $__errorArgs = ['category_goal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <script>
        ...
        function openEditWorkoutPlanModal(id, trainorId, title, description, categoryGoal) {
            ...
            document.getElementById('editWorkoutPlanForm').action = '<?php echo e(url("admin/workout-plans")); ?>/' + id;
...
<?php endif; ?>
<?php /**PATH D:\Downloads\fitnessgains.site (2)\fitnessgains.site (1)\willie\resources\views/admin/workout_plans/index.blade.php ENDPATH**/ ?>