...
<nav x-data="{ open: false }" class="sticky top-0 z-50 glass-effect border-b border-white/20 shadow-xl">
        ...
        <div class="flex justify-between h-20">
            <div class="flex items-center">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="<?php echo e(route('member-portal')); ?>" class="flex items-center space-x-3 group">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <div class="flex space-x-2">
                    <a href="<?php echo e(route('member-portal')); ?>" class="flex items-center space-x-2 px-4 py-2 my-4 rounded-xl text-sm font-medium transition-all duration-300 <?php echo e(request()->routeIs('member-portal') ? 'bg-white/20 text-white shadow-lg' : 'text-white/80 hover:text-white hover:bg-white/10'); ?>">
                    ...
                    <a href="<?php echo e(route('member.workout_plans.index')); ?>" class="flex items-center space-x-2 px-4 py-2 my-4 rounded-xl text-sm font-medium transition-all duration-300 <?php echo e(request()->routeIs('member.workout_plans.*') ? 'bg-white/20 text-white shadow-lg' : 'text-white/80 hover:text-white hover:bg-white/10'); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                        </svg>
                        <span><?php echo e(__('Workout Plans')); ?></span>
                    </a>
                    <a href="<?php echo e(route('member.attendance')); ?>" class="flex items-center space-x-2 px-4 py-2 my-4 rounded-xl text-sm font-medium transition-all duration-300 <?php echo e(request()->routeIs('member.attendance') ? 'bg-white/20 text-white shadow-lg' : 'text-white/80 hover:text-white hover:bg-white/10'); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                        </svg>
                        <span><?php echo e(__('Attendance')); ?></span>
                    </a>
                    <a href="<?php echo e(route('member.progress.index')); ?>" class="flex items-center space-x-2 px-4 py-2 my-4 rounded-xl text-sm font-medium transition-all duration-300 <?php echo e(request()->routeIs('member.progress.index') ? 'bg-white/20 text-white shadow-lg' : 'text-white/80 hover:text-white hover:bg-white/10'); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                        </svg>
                        <span><?php echo e(__('Progress')); ?></span>
                    </a>
                    <a href="<?php echo e(route('member.products')); ?>" class="flex items-center space-x-2 px-4 py-2 my-4 rounded-xl text-sm font-medium transition-all duration-300 <?php echo e(request()->routeIs('member.products') ? 'bg-white/20 text-white shadow-lg' : 'text-white/80 hover:text-white hover:bg-white/10'); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path>
                        </svg>
                        <span><?php echo e(__('Products')); ?></span>
                    </a>
                    <a href="<?php echo e(route('member.profile')); ?>" class="flex items-center space-x-2 px-4 py-2 my-4 rounded-xl text-sm font-medium transition-all duration-300 <?php echo e(request()->routeIs('member.profile') ? 'bg-white/20 text-white shadow-lg' : 'text-white/80 hover:text-white hover:bg-white/10'); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="ml-6 relative" x-data="{ open: false }">
                    <button @click="open = !open" class="flex items-center space-x-3 text-white/80 hover:text-white transition-colors duration-300">
                        <?php if(Auth::user()->member && Auth::user()->member->profile_photo): ?>
                            <img src="<?php echo e(asset('storage/' . Auth::user()->member->profile_photo)); ?>" alt="Profile Photo" class="w-8 h-8 rounded-full object-cover">
                        <?php else: ?>
                            <div class="w-8 h-8 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full flex items-center justify-center">
                                <span class="text-sm font-semibold text-white"><?php echo e(strtoupper(substr(Auth::user()->name, 0, 1))); ?></span>
                            </div>
                        <?php endif; ?>
    ...
    <div 
        ...
        <div class="flex-1 px-6 py-4 space-y-3 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-gray-900">
            <a href="<?php echo e(route('member-portal')); ?>"
               @click="open = false"
            ...
            <a href="<?php echo e(route('member.workout_plans.index')); ?>"
               @click="open = false"
               class="block px-4 py-3 bg-gray-400 rounded-lg text-base font-semibold text-white hover:bg-white/25 transition-all duration-300 shadow-sm shadow-black/50">
                <div class="flex items-center space-x-3">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('member.products')); ?>"
               @click="open = false"
               class="block px-4 py-3 bg-gray-400 rounded-lg text-base font-semibold text-white hover:bg-white/25 transition-all duration-300 shadow-sm shadow-black/50">
                <div class="flex items-center space-x-3">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('member.progress.index')); ?>"
               @click="open = false"
               class="block px-4 py-3 bg-gray-400 rounded-lg text-base font-semibold text-white hover:bg-white/25 transition-all duration-300 shadow-sm shadow-black/50">
                <div class="flex items-center space-x-3">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH D:\Downloads\fitnessgains.site (2)\fitnessgains.site (1)\willie\resources\views/layouts/navs.blade.php ENDPATH**/ ?>